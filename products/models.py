...
class ProductModel(models.Model):
    ...
    sizes = models.ManyToManyField(ProductSizeModel, related_name='products', verbose_name='sizes')
    colors = models.ManyToManyField(ProductColorModel, related_name='products', verbose_name='colors')
    ...
    # skidkada borligini tekshiradi//
    def is_discount(self):
        return self.discount != 0

    # skidkani % zini aniqlash
    # productni oxirgi narxini chiqarish
    def get_price(self):
        if self.is_discount():
            return self.price - self.price * self.discount / 100
        return self.price

    # product yangi bolsa new chiqaradi
    def is_new(self):
